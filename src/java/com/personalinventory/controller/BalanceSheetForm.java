 ...
 * @author rkhjp
 */
public class BalanceSheetForm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> BalanceSheetForm</title>");    
...
//                      
//                    out.println("</tr>");
//                    out.println("<tr id='menu'><td>Total</td><td>182007.0</td></tr>");
//
//                out.println("</table>");
...
//                    out.println("<tr id='menu'><td>Total</td><td>182007.0</td></tr>");
        ...
        out.println("</div>");
            out.println("</form>");
//            out.println("<h1>Servlet BalanceSheetForm at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
