 ...
 * @author rkhjp
 */
public class DeleteECategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteECategory</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            int r =ed.deleteExpCategory(exp_catid);
            if(r>0){
            ...
            out.println("<h1>Servlet DeleteECategory at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteECategory.class.getName()).log(Level.SEVERE, null, ex);
