...
public class BankBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BankBook</title>");
            out.println("</head>");
           ...
           out.println("<tr>");
            ...
            ArrayList<BankBookBean> al = bd.findallDateWise(sdate, edate);
...
//            out.println("</tr>");
            out.println("</table>");
            out.println("</center>");
            out.println("<h1>Servlet BankBook at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
