 ...
 * @author rkhjp
 */
public class expensescategoryform extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("</form>");
            out.println("<body>");
            out.println("<h1>Servlet expensescategoryform at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
