 ...
 * @author rkhjp
 */
public class DayBookForm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DayBookForm</title>");            
        ...
        out.println("<div id='box4'>");
            ...
            out.println("</div>");
        out.println("</form>");
//            out.println("<h1>Servlet DayBookForm at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
